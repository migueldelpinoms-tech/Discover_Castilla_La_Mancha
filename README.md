...
* **Lenguaje:** Java / Kotlin (elige el tuyo)
* **Entorno:** Android Studio
* **BBDD:** SQLite / Firebase
* **Diseño:** Figma (Mockups personalizados)
...
* **Exploración:** Filtros por provincia y categorías (Naturaleza, Patrimonio, etc.).
* **Comunidad:** Sección de foro para compartir experiencias.
